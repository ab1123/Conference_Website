          ...
          <div className='team-sections'>
            ...
            <ul>
              <div className='inner-section'>
                ...
                <p className='dit'>Chairman, DIT Univerity</p>
              </div>
              <div className='inner-section'>
                <li>Shri N. Ravi Shanker</li>
                <p className='dit'> Chancellor, DIT Univerity</p>
              </div>
            </ul>
          </div>
          ...
          <div className='team-sections'>
            ...
            <ul>
              <div className='inner-section'>
                ...
                <p className='dit'>Vice-Chancellor, DIT Univerity</p>
              </div>
              <div className='inner-section'>
          ...
          <div className='team-sections'>
            ...
            <ul>
              <div className='inner-section'>
                ...
                <p className='dit'> Dean SOPS, DIT Univerity</p>
              </div>
              <div className='inner-section'>
          ...
          <div className='team-sections'>
            ...
            <ul>
              <div className='inner-section'>
                ...
                <p className='dit'>SOPS, DIT Univerity</p>
              </div>
              <div className='inner-section'>
          ...
          <div className='team-sections'>
            ...
            <ul>
              <div className='inner-section'>
                ...
                <p className='dit'>DIT Univerity</p>
              </div>
            </ul>
          </div>
        </div>
